...
import WorkoutFormSessions from './Add/WorkoutFormSessions.vue';
...
<template>
  <div>
    <div class="flex justify-center gap-4 mb-4 overflow-x-auto">
      ...
      <button @click="selectedTab = 'sport Sessions'">Sport Séances</button>
    ...
    <WorkoutFormSessions v-if="selectedTab === 'sport Sessions'" />
